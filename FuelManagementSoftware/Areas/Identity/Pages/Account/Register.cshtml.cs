...
namespace FuelManagementSoftware.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Create Organization if registering as Organization
        ...
        private async Task AssignRoleAsync(FuelManagementSoftwareUser user, string registrationType)
        {
            ...
            {
                roleName = "OrganizationAdmin"; // Organization registrants get OrganizationAdmin role
            }
            else
            {
                roleName = "Customer"; // Customer registrants get Customer role
            }
